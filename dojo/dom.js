...
//>>built
define("dojo/dom",["./sniff","./_base/window","./_base/kernel"],function(f,h,g){if(7>=f("ie"))try{document.execCommand("BackgroundImageCache",!1,!0)}catch(l){}var e={};f("ie")?e.byId=function(a,b){if("string"!=typeof a)return a;var c=b||h.doc,d=a&&c.getElementById(a);if(d&&(d.attributes.id.value==a||d.id==a))return d;c=c.all[a];if(!c||c.nodeName)c=[c];for(var e=0;d=c[e++];)if(d.attributes&&d.attributes.id&&d.attributes.id.value==a||d.id==a)return d}:e.byId=function(a,b){return("string"==typeof a?
(b||h.doc).getElementById(a):a)||null};g=g.global.document||null;f.add("dom-contains",!(!g||!g.contains));e.isDescendant=f("dom-contains")?function(a,b){return!(!(b=e.byId(b))||!b.contains(e.byId(a)))}:function(a,b){try{a=e.byId(a);for(b=e.byId(b);a;){if(a==b)return!0;a=a.parentNode}}catch(c){}return!1};f.add("css-user-select",function(a,b,c){if(!c)return!1;a=c.style;b=["Khtml","O","Moz","Webkit"];c=b.length;var d="userSelect";do if("undefined"!==typeof a[d])return d;while(c--&&(d=b[c]+"UserSelect"));
